...
function Je(e2) {
  if (te(e2)) return { message: e2.message, name: e2.name, stack: e2.stack, ...qe(e2) };
  if (le(e2)) {
...
function We(e2, t2) {
  if (function(e3) {
    ...
    const r2 = {};
    t2.set(e2, r2);
    for (const n3 of Object.getOwnPropertyNames(e2)) void 0 !== e2[n3] && (r2[n3] = We(e2[n3], t2));
    return r2;
  }
  if (Array.isArray(e2)) {
    const n2 = t2.get(e2);
...
function jt(e2) {
  ...
  return { $: t2, add: function(r2) {
    if (!(void 0 === e2 || t2.length < e2)) return Ot(new Fe("Not adding Promise because buffer limit was reached."));
    const i2 = r2();
...
function Rn(e2, t2, n2) {
  if (n2[t2.name]) Yt && Le.log(`Integration skipped because it was already installed: ${t2.name}`);
  else {
...
function $n(e2, t2, n2 = jt(e2.bufferSize || 64)) {
  ...
  return { send: function(i2) {
    ...
    return n2.add(() => t2({ body: Jt(a2) }).then((e3) => (void 0 !== e3.statusCode && (e3.statusCode < 200 || e3.statusCode >= 300) && Yt && Le.warn(`Sentry responded with status code ${e3.statusCode} to sent event.`), r2 = Ht(r2, e3), e3), (e3) => {
      ...
      if (e3 instanceof Fe) return Yt && Le.error("Skipped sending event because buffer is full."), s2("queue_overflow"), Pt({});
      throw e3;
    });
...
function lr(e2, t2, n2, r2) {
  ...
  if (a2) return { exception: { values: [cr(e2, a2)] }, extra: s2 };
...
function Er() {
  ...
  _r.onpopstate = function(...t3) {
    ...
    Sr = n2;
    if (it("history", { from: r2, to: n2 }), e2) try {
...
function Ls(e2, t2) {
  var n2 = {};
  for (var r2 in e2) if (e2[r2] instanceof MediaStreamTrack) console.warn("MediaStreamTrack found in props or cache.", r2), n2[r2] = Ho;
    ...
    switch (o2) {
      case "video":
        ...
        for (var s2 = 0, c2 = Object.entries(a2); s2 < c2.length; s2++) {
          ...
          switch (u2) {
            case "processor":
              if (!Hs(d2)) return false;
              break;
            case "settings":
              if (!Gs(d2)) return false;
              break;
            default:
              return false;
          }
      ...
      case "audio":
        ...
        for (var p2 = 0, h2 = Object.entries(a2); p2 < h2.length; p2++) {
          ...
          switch (g2) {
            case "processor":
              if (!Ws(m2)) return false;
              break;
            case "settings":
              if (!Gs(m2)) return false;
              break;
            default:
              return false;
          }
...
function Ws(e2) {
  if (na()) return console.warn("Video processing is not yet supported in React Native"), false;
  var t2 = ["type"];
  return !!e2 && ("object" === n(e2) && (Object.keys(e2).filter(function(e3) {
    ...
    if (!Object.values(Qo).includes(e3)) return console.error("inputSettings audio processor type invalid"), false;
    return true;
  }(e2.type)));
}
function Hs(e2) {
  ...
  if (!function(e3) {
    if ("string" != typeof e3) return false;
    if (!Object.values(Go).includes(e3)) return console.error("inputSettings video processor type invalid"), false;
    return true;
      ...
      switch (e3) {
        ...
        case Go.BGIMAGE:
          return !(void 0 !== t3.source && !function(e4) {
            ...
            if (Z(e4.source)) return e4.type = "url", !!function(e5) {
...
function Zs(e2) {
  if (!e2 || e2 && "object" !== n(e2) || Array.isArray(e2)) return console.error(Ks()), false;
...
function ec(e2, t2) {
  ...
  switch (n(t2)) {
    ...
    case "object":
      if ("object" !== n(e2)) return false;
      for (var r2 in e2) if (!ec(e2[r2], t2[r2])) return false;
      return true;
    default:
      return false;
  }
...
function nc(e2) {
  ...
  if (e2.state && !Object.values(Yo).includes(e2.state)) throw new Error("Invalid value for RemoteMediaPlayerSettings.state, valid values are: " + JSON.stringify(Yo));
  if (e2.volume) {
  ...
  "node_modules/@daily-co/daily-js/dist/daily-esm.js"() {
    ...
    Un = class {
      ...
      captureException(e2, t2, n2) {
        const r2 = yt();
        if (St(e2)) return Yt && Le.log(Bn), r2;
      ...
      captureEvent(e2, t2, n2) {
        const r2 = yt();
        if (t2 && t2.originalException && St(t2.originalException)) return Yt && Le.log(Bn), r2;
      ...
      _processEvent(e2, t2, n2) {
        ...
        if (a2 && "number" == typeof l2 && Math.random() > l2) return this.recordDroppedEvent("sample_rate", "error", e2), Ot(new Fe(`Discarding event because it's not included in the random sample (sampling rate = ${i2})`, "log"));
        ...
        return this._prepareEvent(e2, t2, n2, d2).then((n3) => {
          if (null === n3) throw this.recordDroppedEvent("event_processor", u2, e2), new Fe("An event processor returned `null`, will not send event.", "log");
          ...
          return function(e3, t3) {
            ...
            if (ue(e3)) return e3.then((e4) => {
              if (!ce(e4) && null !== e4) throw new Fe(n4);
              return e4;
            }, (e4) => {
              throw new Fe(`${t3} rejected with ${e4}`);
            });
            if (!ce(e3) && null !== e3) throw new Fe(n4);
            return e3;
          }(i3, c2);
        }).then((r3) => {
          if (null === r3) {
...
Reason: ${e3}`);
      ...
      _flushOutcomes() {
        ...
        if (0 === e2.length) return void (Yt && Le.log("No outcomes to send"));
    ...
    Kn = (e2 = {}) => ({ name: "InboundFilters", processEvent(t2, n2, r2) {
      ...
      return function(e3, t3) {
        if (t3.ignoreInternal && function(e4) {
          ...
          return false;
        }(e3)) return Yt && Le.warn(`Event dropped due to being internal Sentry Error.
Event: ${bt(e3)}`), true;
        if (function(e4, t4) {
        ...
        }(e3, t3.ignoreErrors)) return Yt && Le.warn(`Event dropped due to being matched by \`ignoreErrors\` option.
Event: ${bt(e3)}`), true;
        if (function(e4) {
        ...
        }(e3)) return Yt && Le.warn(`Event dropped due to not having an error message, error type or stacktrace.
Event: ${bt(e3)}`), true;
        if (function(e4, t4) {
          if ("transaction" !== e4.type || !t4 || !t4.length) return false;
          const n3 = e4.transaction;
          return !!n3 && ge(n3, t4);
        }(e3, t3.ignoreTransactions)) return Yt && Le.warn(`Event dropped due to being matched by \`ignoreTransactions\` option.
Event: ${bt(e3)}`), true;
        if (function(e4, t4) {
          if (!t4 || !t4.length) return false;
          const n3 = Xn(e4);
          return !!n3 && ge(n3, t4);
        }(e3, t3.denyUrls)) return Yt && Le.warn(`Event dropped due to being matched by \`denyUrls\` option.
Event: ${bt(e3)}.
Url: ${Xn(e3)}`), true;
        if (!function(e4, t4) {
          ...
          const n3 = Xn(e4);
          return !n3 || ge(n3, t4);
        }(e3, t3.allowUrls)) return Yt && Le.warn(`Event dropped due to not being matched by \`allowUrls\` option.
Event: ${bt(e3)}.
Url: ${Xn(e3)}`), true;
        return false;
      }(t2, o2) ? null : t2;
      ...
      return { name: "Dedupe", processEvent(t2) {
        ...
        try {
          if (function(e3, t3) {
            ...
            return false;
          }(t2, e2)) return Yt && Le.warn("Event dropped due to being a duplicate of previously captured event."), null;
        } catch (e3) {
        }
        return e2 = t2;
      } };
    ...
    mr = class extends Un {
      ...
      captureUserFeedback(e2) {
        ...
        const t2 = function(e3, { metadata: t3, tunnel: n2, dsn: r2 }) {
          const i2 = { event_id: e3.event_id, sent_at: (/* @__PURE__ */ new Date()).toISOString(), ...t3 && t3.sdk && { sdk: { name: t3.sdk.name, version: t3.sdk.version } }, ...!!n2 && !!r2 && { dsn: Ie(r2) } }, o2 = /* @__PURE__ */ function(e4) {
    ...
    Ua = function() {
      ...
      return o(e2, [{ key: "start", value: (a2 = h(function* () {
        ...
        try {
          ...
          if (clearTimeout(this._networkTimeout), t3 instanceof Fa || this.cancelled || this._networkTimedOut) return;
    ...
    Os = { customIntegrations: { validate: Zs, help: Ks() }, customTrayButtons: { validate: Xs, help: "customTrayButtons should be a dictionary of the type ".concat(JSON.stringify(Ts)) }, url: { validate: function(e2) {
      ...
      var n2;
      if (e2 instanceof MediaStreamTrack) t2._sharedTracks.videoTrack = e2, n2 = { customTrack: Ho };
      else {
      ...
      var n2;
      if (e2 instanceof MediaStreamTrack) t2._sharedTracks.audioTrack = e2, n2 = { customTrack: Ho };
      else {
    ...
    js = function() {
      ...
      return o(ee2, [{ key: "destroy", value: (Y2 = h(function* () {
        ...
        if (Rs(this._callObjectMode, "updateWaitingParticipant()"), xs(this._callState, "updateWaitingParticipant()"), "string" != typeof t2 || "object" !== n(r3)) throw new Error("updateWaitingParticipant() must take an id string and a updates object");
        ...
        if (Rs(this._callObjectMode, "updateWaitingParticipants()"), xs(this._callState, "updateWaitingParticipants()"), "object" !== n(t2)) throw new Error("updateWaitingParticipants() must take a mapping between ids and update objects");
        ...
        var t2 = this;
        if (Rs(this._callObjectMode, "updateReceiveSettings()"), !$s(e2, { allowAllParticipantsKey: true })) throw new Error(Ys({ allowAllParticipantsKey: true }));
        ...
        if (e2.video) {
          var i3, o2, a2;
          if (r3.video = {}, e2.video.settings) r3.video.settings = {}, t2 || e2.video.settings.customTrack || null === (a2 = n2.video) || void 0 === a2 || !a2.settings ? r3.video.settings = e2.video.settings : r3.video.settings = fs(fs({}, n2.video.settings), e2.video.settings), Object.keys(r3.video.settings).length || delete r3.video.settings;
        ...
        if (e2.audio) {
          var s3, c2, l3;
          if (r3.audio = {}, e2.audio.settings) r3.audio.settings = {}, t2 || e2.audio.settings.customTrack || null === (l3 = n2.audio) || void 0 === l3 || !l3.settings ? r3.audio.settings = e2.audio.settings : r3.audio.settings = fs(fs({}, n2.audio.settings), e2.audio.settings), Object.keys(r3.audio.settings).length || delete r3.audio.settings;
          else null !== (s3 = n2.audio) && void 0 !== s3 && s3.settings && (r3.audio.settings = n2.audio.settings);
        ...
        if (Us(), this._callMachineInitialized) return this.sendMessageToCallMachine({ action: "set-bandwidth", kbs: t2, trackConstraints: n2 }), this;
        ...
        if (Us(), void 0 !== i3 && (n2 = i3), void 0 !== o2 && (r3 = o2), "boolean" == typeof n2 && (this._setAllowLocalAudio(n2), n2 = void 0), "boolean" == typeof r3 && (this._setAllowLocalVideo(r3), r3 = void 0), !n2 && !r3) return yield this.getInputDevices();
        var a2 = {};
        ...
        var e2 = this, t2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
        if (Rs(this._callObjectMode, "preAuth()"), Ds(this._callState, this._isPreparingToJoin, "preAuth()"), this.needsLoad() && (yield this.load(t2)), !t2.url) throw new Error("preAuth() requires at least a url to be provided");
        ...
        if (Ns(this._callMachineInitialized, "startScreenShare()"), t2.screenVideoSendSettings && this._validateVideoSendSettings("screenVideo", t2.screenVideoSendSettings), t2.mediaStream && (this._sharedTracks.screenMediaStream = t2.mediaStream, t2.mediaStream = Ho), "undefined" != typeof DailyNativeUtils && void 0 !== DailyNativeUtils.isIOS && DailyNativeUtils.isIOS) {
          ...
          if (yield n2.isScreenBeingCaptured()) return void this.emitDailyJSEvent({ action: Bo, type: "screen-share-error", errorMsg: "Could not start the screen sharing. The screen is already been captured!" });
        ...
        } else this.sendMessageToCallMachine({ action: qo, captureOptions: t2 });
      }), function() {
        ...
        if (e2) {
          ...
          if (!rc(e2.length, 1, 3)) throw new Error("encodings must be an Array with between 1 to ".concat(3, " layers"));
          for (var r3 = 0; r3 < e2.length; r3++) {
            ...
            for (var o2 in this._validateEncodingLayerHasValidProperties(i3), i3) if (Ms.includes(o2)) {
              ...
              if (t2) {
                ...
                if (!rc(i3[o2], s3, c2)) throw new Error("".concat(o2, " value not in range. valid range: ").concat(s3, " to ").concat(c2));
              }
        ...
        for (var d2 in e2) {
          if (!Os[d2]) throw new Error("unrecognized property '".concat(d2, "'"));
          if (Os[d2].validate && !Os[d2].validate(e2[d2], this)) throw new Error("property '".concat(d2, "': ").concat(Os[d2].help));
        }
        ...
        if (null !== (t2 = e2.error) && void 0 !== t2 && t2.type) {
          if (![Ti, Ci, Si].includes(e2.error.type)) return;
          if (e2.error.type === Si && e2.error.msg.includes("deleted")) return;
        }
        ...
        if (na()) return { supported: true, mobile: true, name: "React Native", version: null, supportsScreenShare: true, supportsSfu: true, supportsVideoProcessing: false, supportsAudioProcessing: false };
    ...
    var Vapi = class extends VapiEventEmitter {
      ...
      async start(assistant, assistantOverrides, squad, workflow) {
        ...
        try {
          ...
          const isVideoEnabled = ((_c = (_b = webCall == null ? void 0 : webCall.assistant) == null ? void 0 : _b.voice) == null ? void 0 : _c.provider) === "tavus";
